...
[NSBundle bundleWithPath:[[NSBundle mainBundle] pathForResource:@"DDMIResource" ofType:@"bundle"]]
#endif

#ifndef DDMISDKBundleImage
#define DDMISDKBundleImage(s) \
[UIImage imageNamed:[[[NSBundle mainBundle] pathForResource:@"DDMIResource" ofType:@"bundle"] stringByAppendingPathComponent:s]]
#endif
