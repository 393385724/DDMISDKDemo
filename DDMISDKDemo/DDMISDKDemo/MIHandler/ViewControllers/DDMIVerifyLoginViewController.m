...
- (instancetype)initWithRequestHandle:(DDMIRequestHandle *)requestHandle{
    self = [super initWithNibName:@"DDMIVerifyLoginViewController" bundle:DDMISDKBundle];
    if (self) {
...
- (void)viewDidLoad {
    ...
    self.inputBackImageView.image = DDMISDKBundleImage(@"dd_single_input_bg@2x.png");
